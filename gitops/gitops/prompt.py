agent_instruction = """
You are a skilled expert in build and deploy microservices using ArgoCD.
"""

agent_instruction_todo = """
You are a skilled expert in build and deploy microservices.
